                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div>
                                <div className="font-heading font-bold text-xl text-white">Safari Adventures</div>
                                <div className="text-sm text-amber-600">Kenya</div>
                            </div>
                        </div>
                        <p className="text-sm mb-4">
                            Experience the magic of Kenya with our expertly curated safari packages.
                            We bring you closer to Africa's most spectacular wildlife.
                        </p>
                        <div className="flex gap-4">
                            <a href="https://facebook.com" aria-label="Facebook" className="hover:text-amber-600 transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                            </a>
                            <a href="https://twitter.com" aria-label="Twitter" className="hover:text-amber-600 transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                                </svg>
                            </a>
                            <a href="https://instagram.com" aria-label="Instagram" className="hover:text-amber-600 transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/accommodations" className="text-gray-400 hover:text-amber-500 transition-colors">
                                    Hotels & Lodges
                                </Link>
                            </li>
                            <li>
                    ...
                    {/* Top Destinations */}
                    <div>
                        <h3 className="text-white font-heading font-semibold text-lg mb-4">Top Destinations</h3>
                        <ul className="space-y-2">
                            {[
                                ...
                                { name: 'Samburu Reserve', href: '/destinations/samburu' },
                            ].map((item) => (
                                <li key={item.name}>
                                    <Link href={item.href} className="hover:text-amber-600 transition-colors text-sm">
                                        {item.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex gap-2">
                                ...
                                <span>123 Safari Street, Nairobi, Kenya</span>
                            </li>
                            <li className="flex gap-2">
                                <svg className="w-5 h-5 text-amber-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span>+254 702 075 876 / +254 713 091 092</span>
                            </li>
                            <li className="flex gap-2">
                                <svg className="w-5 h-5 text-amber-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span>info@safariadventureskenya.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
