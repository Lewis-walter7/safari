                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="card p-8 text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 mb-4 text-gray-700 gradient-primary rounded-full">
                                    <div className="text-white">{value.icon}</div>
                                </div>
                                <h3 className="heading-tertiary text-gray-900 dark:text-white mb-3">
                                    {value.title}
                                </h3>
